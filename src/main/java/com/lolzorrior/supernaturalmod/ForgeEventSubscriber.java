...
public class ForgeEventSubscriber {
    ...
    public static void onPlayerLogsIn(PlayerLoggedInEvent event) {
        ...
        player.sendMessage(new StringTextComponent("Welcome, your power is " + (supernaturalClass.getPower())), event.getEntity().getUniqueID());
        player.sendMessage(new StringTextComponent("Your class is " + supernaturalClass.getSupernaturalClass()), event.getEntity().getUniqueID());
    }
